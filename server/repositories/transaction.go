...
type TransactionRepository interface {
	...
	UpdateSold(house models.House, sold bool) error
...
func (r *repository) UpdateSold(house models.House, sold bool) error {
	err := r.db.Model(&house).Update("sold", sold).Error // Using Save method
