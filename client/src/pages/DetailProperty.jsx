          ...
          <Col className="mt-5">
            ...
            <div className="d-flex justify-content-md-end">
              {!localStorage.getItem("token") ? (
                ...
                <Button month={month} className=" mt-5 px-5" onClick={() => setModalShowBooking(true)}>
                  Book Now
                </Button>
              )}

              <MyBookingModal month={month} detail={detail && detail} show={modalShowBooking} onHide={() => setModalShowBooking(false)} />
            </div>
          </Col>
        </Row>
      </Container>
