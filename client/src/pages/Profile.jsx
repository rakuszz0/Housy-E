...
export default function Profile(props) {
  ...
  console.log("apa ini " + userId)
  return (
    <div className="">
      <NavbarWithoutSearch />
      <Container className="">
        <Row className="pp justify-content-between bg-white p-5">
          <Col className="d-flex flex-column gap-5 " sm={5}>
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div className="d-flex flex-column">
                <span className="p-0 m-0 fw-semibold">{state.user.list_as_role}</span>
          ...
          <Col className=" p-0 d-flex flex-column gap-3" sm={5}>
            <div className="">
              <img className="shadow rounded " style={{ width: "300px", height: "430px", objectFit: "cover" }} src={userId?.image != "" ? userId?.image : imgp3} alt="" />
            </div>
            <div>
